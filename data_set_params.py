...
class DataSetParams:
    ...
    def __init__(self):
        ...
        # CNN params
        self.learn_rate = 0.01  #Input von GUI
        self.moment = 0.9   #Input von GUI
        self.num_epochs = 50    #kann weniger sein.Input von GUI. Optimalewert finden, eine Funktion
        self.batchsize = 256    #Input von GUI
    ...
    def spectrogram_params(self):
        ...
        self.valid_file_length = 169345  # some files are longer than they should be # 79766
